...
0. ![Sled Blank](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/sled_blank.jpg)
2. Mark the center on your sled blank and cut a 2 - 2.5" hole as close to center as possible.
0. ![Sled Blank with Hole](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/sled_blank_w_hole.jpg)
...
0. ![Placing Rods Base](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/placing_rods_base.jpg)
...
0. ![Dry-fit / Hole Marking](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/dry_fit_hole_marking.jpg)
...
0. Once you've drilled all of your holes, you can remove the bullseye from the rods base. Just use an X-acto knife or similar to snip it off close to the base:
    0. ![Remove the Bullseye](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/remove_bullseye.jpg)
...
0. ![Assemble Rods Base](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/assemble_rods_base.jpg)
...
0. Now prepare the router clamp as follows:
    ...
    0. ![Upper Half Assembled (1)](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/upper_half_assembled_1.jpg)
    0. ![Upper Half Assembled (2)](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/upper_half_assembled_2.jpg)
    ...
    0. ![Install Cleating Screws](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/install_cleating_screws.jpg)
    ...
    0. ![Install Cleating Screws (2)](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/install_cleating_screws_2.jpg)
0. Install the upper half of the router clamp:
    0. Place the "bottom" piece (the one with the dust sleeve attached) on the rails. Some notes:
        ...
        a. ![Install Upper Half](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/install_upper_half.jpg)
        a. Now place the other top-half piece, making sure to flip it so the bearing holders are touching each other, as shown.
        a. ![Install Upper Half (2)](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/install_upper_half_2.jpg)
0. Assemble the Axis Cap:
    ...
    0. ![Rod Holders](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/secure_rod_holders.jpg)
    ...
    0. ![Don't Install Square Nuts](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/dont_install_nuts_here.jpg)
    ...
    0. ![Mount Motor in Axis Cap](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/mount_motor.jpg)
0. Mount the Axis Cap:
    ...
    0. ![Place Coupler](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/place_coupler.jpg)
    0. Gently place the axis cap on top of the linear rails and slide the motor shaft into the coupler, as shown:
    0. ![Place Axis Cap](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/place_axis_cap.jpg)
    ...
    0. ![Secure Axis Cap](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/secure_axis_cap.jpg)
0. Bolt the Axis Cap to the Motor Brace Assembly using two 8Mx35mm bolts and two M8 square nuts. You will need to hold the square nuts in place from underneath--the slots for them are on the bottom face of the Axis Cap.
    0. ![Bolt Axis Cap](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/bolt_axis_cap.jpg)
0. Place the Router
    ...
    0. ![Secure Router](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/secure_router.jpg)
![Fully Assembled](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/fully_assembled.jpg)
...
0. The dust sleeve is designed to go on and come off easily so you can access the collet and change bits. To place it initially:
    ...
    0. ![Using the Dust Sleeve](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/dust_sleeve_1.jpg)
    ...
    0. ![Using the Dust Sleeve](https://github.com/MaslowCommunityGarden/Yet-Another-Z-Axis-Mod/raw/master/dust_sleeve_2.jpg)
